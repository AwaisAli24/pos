    ...
    <div className="inventory-container">
      ...
      <main className="inventory-main">
        ...
        <div className="inventory-header">
          <div>
            <h1 style={{ fontSize: '1.8rem', fontWeight: '800', color: 'var(--text-main)' }}>Glass Business HR</h1>
            <p style={{ color: '#64748b', marginTop: '0.3rem' }}>Manage glass & aluminum workers, attendance & payroll</p>
          </div>
