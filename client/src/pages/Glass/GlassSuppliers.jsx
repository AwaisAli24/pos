  ...
  return (
    <div className="suppliers-container">
      <nav className="sidebar-min">
        <div className="nav-item" onClick={() => navigate('/glass-billing')} title="POS / Billing"><ShoppingCart size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-inventory')} title="Inventory"><Package size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-purchases')} title="Purchases"><Truck size={20} /></div>
        <div className="nav-item active" title="Suppliers"><Users size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-customers')} title="Customers"><Store size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-sales')} title="Sales History"><List size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-dashboard')} title="Dashboard"><LayoutDashboard size={20} /></div>
        <div className="nav-item" onClick={() => navigate('/glass-reports')} title="Reports"><BarChart3 size={20} /></div>
        ...
        <div className="nav-item" onClick={() => navigate('/glass-settings')} title="Settings" style={{ marginTop: 'auto' }}><Settings size={20} /></div>
      </nav>

      <main className="suppliers-main">
        <header className="suppliers-header">
          <div className="suppliers-title-group">
            <h1>Glass Material Vendors</h1>
            <p>Manage aluminum and glass suppliers, contact info, and outstanding balances</p>
          </div>
